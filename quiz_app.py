...
3. Complete the 10-question assessment in Section II.""")
    ...
    qs = [
        {
            "q": "In 'point-light' studies, what specific information allowed observers to identify sex and emotion?",
            "o": ["The specific patterns of movement", "The static arrangement of dots"],
        ...
        {
            "q": "What does the research term 'tie-signs' refer to in social groups?",
            "o": ["Specific cues that signal a relationship exists", "The formal dress codes of an organization"],
            "c": "Specific cues that signal a relationship exists",
            "e": "Tie-signs are signals like a hand on a shoulder that inform observers of the specific bond or 'tie' between two people."
        },
        {
            "q": "According to research, what skill is most closely linked to social success in children?",
            "o": ["The ability to read facial muscle movements", "The ability to memorize academic facts"],
            "c": "The ability to read facial muscle movements",
            "e": "Children who can accurately decode nonverbal 'muscle movements' are better at navigating social nuances and gain higher peer acceptance."
        },
        {
            "q": "When a person leans their torso forward, what is the most likely social signal?",
            "o": ["High levels of receptivity and interest", "General boredom or fatigue"],
            "c": "High levels of receptivity and interest",
            "e": "
